...
public class BookingRepository implements IBookingRepository {
    private static final Set<Booking> data = new TreeSet<>(new ComparatorBooking());
    ...
    static {
        ...
        Booking booking2 = new Booking("BK-2222", "24-12-2023", "25-12-2022", "26-12-2022", customer1, listFacility.get(0));
        Booking booking3 = new Booking("BK-3333", "24-12-2023", "25-12-2023", "26-12-2022", customer1, listFacility.get(0));
        data.add(booking1);
        data.add(booking2);
        data.add(booking3);
    }
